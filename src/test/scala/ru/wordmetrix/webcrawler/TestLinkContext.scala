...
import ru.wordmetrix.webcrawler.LinkContext._
    ...
    "gives a map with empty vectors" in {
      ...
      extract.extract(
        <html>
          ...
          <body>
            <h1>
              <a href="http://example.org">Header</a>
            </h1>
            <p>
              <a href="http://example.org/1">SomeLink</a>
            </p>
            <p></p>
          </body>
        </html>
      ...
      extract.extract(
        <html>
          ...
          <body class="test">
            ...
            <p>
              <a id="ref" href="http://example.org/1">SomeLink</a>
            </p>
            <p></p>
          </body>
        </html>
    ...
    "gives a map with two classes" in {
      ...
      extract.extract(
        <html>
          ...
          <body class="body">
            <h1>
              <a class="header" href="http://example.org">Header</a>
            </h1>
            <p>
              <a id="ref" href="http://example.org/1">SomeLink</a>
            </p>
    ...
    "gives a map with one class twice" in {
      extract.extract(
        <html>
          ...
          <body class="body">
            <h1>
              <a class="body" href="http://example.org">Header</a>
            </h1>
            <p>
              <a id="ref" href="http://example.org/1">SomeLink</a>
            </p>

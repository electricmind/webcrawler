...
import ru.wordmetrix.webcrawler.Gather.GatherLinkContext
import ru.wordmetrix.webcrawler.LinkContext.FeatureName
import ru.wordmetrix.webcrawler.SampleHierarchy2Priority._

class TestSampleHierarchy2Priority
  extends TestKit(ActorSystem("TestSampleHierarchy2Priority"))
  with Tools

...
class testLinkContext extends FlatSpec with Matchers {
    ...
    "An simple xml" should "gives a map with class and id" in {
        extract.extract(
            <html>
                <head>
                    <title>Title</title>
        ...
        "An simple xml" should "gives a map with two classes" in {
        ...
        "An simple xml" should "gives a map with one class twice" in {
        extract.extract(
            <html>
                <head>
                    <title>Title</title>
